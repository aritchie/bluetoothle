...
namespace Plugin.BluetoothLE
{
    ...
    public static class Dictionaries
    {
        ...
        {
            return KnownCharacteristics.ContainsKey(uuid) ? KnownCharacteristics[uuid] : String.Empty;
        }


        public static string GetServiceDescription(Guid uuid)
        {
            return KnownServices.ContainsKey(uuid) ? KnownServices[uuid] : String.Empty;
        }


        public static string GetDescriptorDescription(Guid uuid)
        {
            return KnownDescriptors.ContainsKey(uuid) ? KnownDescriptors[uuid] : String.Empty;
        }
